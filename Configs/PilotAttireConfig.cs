...
namespace ProfessionalAttireRevisited
{
    public class PilotAttireConfig : IEquipmentConfig
    {
        ...
        public static void ConfigureRecipe()
        {
            ...
            {
                new ComplexRecipe.RecipeElement(GameTags.Fabrics, settings.PilotFiberCost),
                new ComplexRecipe.RecipeElement(ElementLoader.FindElementByHash(SimHashes.Steel).tag, settings.PilotSteelCost)
            };
        ...
        public EquipmentDef CreateEquipmentDef()
        {
            ...
            attributeModifiers.Add(new AttributeModifier(Db.Get().Attributes.SpaceNavigation.Id, AttributeIncrease, DisplayName, false, false, true));
