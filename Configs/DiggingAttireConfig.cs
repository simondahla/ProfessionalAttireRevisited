...
namespace ProfessionalAttireRevisited
{
    public class DiggingAttireConfig : IEquipmentConfig
    {
        ...
        public static void ConfigureRecipe()
        {
            ...
            {
                new ComplexRecipe.RecipeElement(GameTags.Fabrics, settings.DiggerFiberCost),
                new ComplexRecipe.RecipeElement(ElementLoader.FindElementByHash(SimHashes.Obsidian).tag, settings.DiggerObsidianCost)
            };
