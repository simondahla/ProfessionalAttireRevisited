...
namespace ProfessionalAttireRevisited
{
    public class ArtistAttireConfig : IEquipmentConfig
    {
        ...
        public static void ConfigureRecipe()
        {
            ...
            {
                new ComplexRecipe.RecipeElement(GameTags.Fabrics, settings.ArtistFiberCost),
                new ComplexRecipe.RecipeElement(ElementLoader.FindElementByHash(SimHashes.Diamond).tag, settings.ArtistDiamondCost)
            };
        ...
        public EquipmentDef CreateEquipmentDef()
        {
            ...
            attributeModifiers.Add(new AttributeModifier(Db.Get().Attributes.Art.Id, AttributeIncrease, DisplayName, false, false, true));
