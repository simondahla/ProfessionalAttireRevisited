...
namespace ProfessionalAttireRevisited
{
    public class CookAttireConfig : IEquipmentConfig
    {
        ...
        public static void ConfigureRecipe()
        {
            ...
            {
                new ComplexRecipe.RecipeElement(GameTags.Fabrics, settings.CookFiberCost),
                new ComplexRecipe.RecipeElement(ElementLoader.FindElementByHash(SimHashes.Polypropylene).tag, settings.CookPolypropyleneCost)
            };
        ...
        public EquipmentDef CreateEquipmentDef()
        {
            ...
            attributeModifiers.Add(new AttributeModifier(Db.Get().Attributes.Cooking.Id, AttributeIncrease, DisplayName, false, false, true));
